...
public class Solution {
    ...
    private static void train(int epochs) throws IOException {
        ...
        for (int i = 1; i < epochs; i++) {
            ...
            for (int j = 0; j < batchSize; j++) {
                ...
                double[] outputs = nn.ff(inputs[imgIndex]);
                int maxDigit = 0;
            ...
            System.out.println("Epoch: " + i + ". True: " + right + ". Loss: " + errorSum);
            if (i >= epochs - 10 && i < epochs - 1) {
                error = (error + errorSum) / 2;
            }
        }
        System.out.println("Total trained: " + epochs + "\nFinal loss:" + (100 - Math.ceil(error)) + "%");
    }
